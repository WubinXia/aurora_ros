...
namespace rpos { namespace core {
    ...
    enum RPOS_CORE_API JackReq
    {
        JACK_REQUEST_DETECT_BASE            = 1,
        JACK_REQUEST_LIFT_UP,
        JACK_REQUEST_LIFT_DOWN,
        JACK_REQUEST_STOP,
        JACK_REQUEST_CLR_ALARM,
    };
    ...
    struct RPOS_CORE_API JackStaus
    {
        std::uint16_t stage; //
        std::uint16_t drv_status;
        std::uint16_t alarm;
