...
#include <rpos/core/obstacle_description.h>
...
namespace rpos { namespace system { namespace serialization { namespace json {
    ...
    template <>
    struct RPOS_CORE_API Serializer < core::DynamicObstacleDesc > {
        static Json::Value serialize(const core::DynamicObstacleDesc& v);
        static core::DynamicObstacleDesc deserialize(const Json::Value& v);
    };
    ...
    template <>
    struct RPOS_CORE_API Serializer < core::JackReq > {
        static Json::Value serialize(const core::JackReq& tVal);
        static core::JackReq deserialize(const Json::Value& jsnVal);
    };

    template <>
    struct RPOS_CORE_API Serializer < core::JackStaus > {
        static Json::Value serialize(const core::JackStaus& tVal);
        static core::JackStaus deserialize(const Json::Value& jsnVal);
    };
