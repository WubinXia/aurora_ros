...
namespace rpos { namespace robot_platforms {
    ...
    public:
        ...
        actions::MoveAction recoverLocalizationByStartupArea(const features::motion_planner::RecoverLocalizationOptions& options = features::motion_planner::RecoverLocalizationOptions());
        ...
        features::motion_planner::Path searchPath(const core::Location& location, int timeoutMs = 10000, bool onlyUseGlobalCostmapSearch = false);
    ...
    public:
        ...
        bool setJackReq(rpos::core::JackReq jackReq);
        rpos::core::JackStaus getJackStatus();
