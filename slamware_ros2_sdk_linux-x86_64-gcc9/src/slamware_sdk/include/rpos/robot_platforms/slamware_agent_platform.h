...
namespace rpos { namespace robot_platforms {
    ...
    public:
        ...
        features::motion_planner::Path searchPath(const core::Location& location, int timeoutMs, bool onlyUseGlobalCostmapSearch);
        ...
        rpos::actions::MoveAction modifyParamsMoveTo(const std::vector<rpos::core::Location>& locations, const rpos::features::motion_planner::ModifyParamsMoveToActionOptions& options);
    public:
    ...
    public:
        std::vector<detail::objects::FloorIdentify> getFloors();
        void setCurrentFloor(const std::string& building, const std::string& floor, const boost::optional<rpos::core::Pose>& pose = boost::none);
        detail::objects::FloorInfo getCurrentFloor();
        bool startDepthCameraCapture(detail::objects::CameraDataType type);
        void stopDepthCameraCapture();
        std::vector<detail::objects::CameraData> getDepthCameraImages(detail::objects::CameraDataType type);
    private:
