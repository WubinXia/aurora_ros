    ...
    namespace features {
        namespace location_provider {
            ...
            enum MapType {
                MapTypeBitmap8Bit = 0,
                MapTypePointmap,
                MapTypeImageFeaturesMap,
                MapTypeRectangleAreaMap
            };
            ...
            public:
                ...
                system::types::timestamp_t getMapTimestamp() const;
            ...
            public:
                ...
                //rpos::system::types::_u64 getMapTimeStamp() const;
                void setTimestamp(rpos::system::types::_u64 timestamp);
                std::vector<rpos::system::types::_u8>& getMapData() const;
                void resize(const core::Vector2f& position, const core::Vector2i& dimension, float resolution);
                void setCellRaw(uint32_t row, uint32_t col, rpos::system::types::_u8 value);
                rpos::system::types::_u8 getCellRaw(uint32_t row, uint32_t col) const;
            };
