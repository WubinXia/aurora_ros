    ...
    namespace features {
        ...
        namespace motion_planner {
            ...
            struct RPOS_CORE_API MoveToTagOptions
            {
                ...
                /*
                * specify the navigation mode on the way to target, MoveOptionFlagWithYaw and yaw is ignored
                */
                MoveOptions move_options;
                ...
                */
                ...
                /*
                * The diameter of column clusters
                */
                boost::optional<float> shelves_columnar_diameter;
                /*
                * The length of the shelf columnar
                */
                boost::optional<float> shelves_length;
                /*
                * The width of the shelf columnar
                */
                boost::optional<float> shelves_width;
                /*
                * Vehicle docking allowance
                */
                boost::optional<float> dock_allowance;
                
                /*
                * max retry count when dock failed
                */
                boost::optional<int> dock_retry_count;
            };
            ...
            struct RPOS_CORE_API ModifyParamsMoveToActionOptions
            {
                ModifyParamsMoveToActionOptions();
                ModifyParamsMoveToActionOptions(MoveOptions options);
                MoveOptions move_options;
                boost::optional<double> robot_size;
                boost::optional<float> robot_line_speed;
                boost::optional<float> robot_angular_speed;
                boost::optional<float> linear_acceleration;
                boost::optional<float> linear_deceleration;
                boost::optional<float> angular_acceleration;
                boost::optional<float> angular_deceleration;
                /*
                * when robot arrived at target, keep moving for the specified distance
                * true means moving forward, false means keep moving backward
                */
                boost::optional<float> align_distance;
            };
        }
        ...
        public:
            ...
            rpos::actions::MoveAction recoverLocalizationByStartupArea(const motion_planner::RecoverLocalizationOptions& options);
            ...
            rpos::features::motion_planner::Path searchPath(const rpos::core::Location& location, int timeoutMs, bool onlyUseGlobalCostmapSearch);
            ...
            rpos::actions::MoveAction modifyParamsMoveTo(const std::vector<rpos::core::Location>& locations, const motion_planner::ModifyParamsMoveToActionOptions& options);
        };
