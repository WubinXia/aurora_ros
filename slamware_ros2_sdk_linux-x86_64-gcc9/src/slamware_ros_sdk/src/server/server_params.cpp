...
namespace slamware_ros_sdk {
    ...
    void ServerParams::resetToDefault()
    {
        ...
        this->declare_parameter<float>("system_status_pub_period", 0.05f);
        this->declare_parameter<float>("stereo_image_pub_period", 0.067f);
        this->declare_parameter<float>("point_cloud_pub_period", 0.1f);
